...
const ce = document.querySelector("polygon.center");
...
tl.add("Madeby");
tl.call(function () { startText.innerHTML = "Madeby" });
tl.set(startText, { opacity: 0, attr: { textLength: 160 }, scale: 1, x: -50, fontSize: "2.5vw" });
tl.staggerTo(polygons, 0.7, { scaleX: 1.2, scaleY: 0.8, ease: Power1.easeOut, stagger: { amount: 0.5, from: "center" } }, "Madeby");
tl.to(startText, 0.7, { opacity: 1, }, "Madeby");
tl.set(startText, { x: "+=47px", scale: 1.3 });
tl.call(function () { startText.innerHTML = "we" });
...
tl.call(function () { startText.innerHTML = "best" });
